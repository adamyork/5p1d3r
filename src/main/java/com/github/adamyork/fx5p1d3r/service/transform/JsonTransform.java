 ...
 * Copyright 2017
 */
public class JsonTransform extends BaseResultTransform implements TransformService {

    private static final Logger logger = LogManager.getLogger(JsonTransform.class);


    public JsonTransform(final ApplicationFormState applicationFormState,
